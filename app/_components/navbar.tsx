...
export default function Navbar() {
  return (
    <nav className="flex gap-x-4 items-center justify-between bg-gray-50 shadow-sm pl-4">
      <Link href="/">
      <span className={`glaciall-bold text-4xl tracking-widest text-morange`}>ME</span><span className="blanka text-[2rem] tracking-widest text-mblue">DAT</span><span className="blanka text-[2rem] tracking-widest text-mred">KA</span> 
      </Link>
      <AuthNav />
    </nav>
  );
